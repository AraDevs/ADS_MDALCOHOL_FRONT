...
export const SAVE_BILLS = createAction(
  '[Bills] Save Bills',
...
export const UPDATE_BILLS_SUCCESS = createAction(
  '[Bills] Update Bills Success'
);
